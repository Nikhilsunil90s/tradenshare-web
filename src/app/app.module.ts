...
import { AuthService, SystemService, ComplainService, PhoneService } from './shared/services';
...
import { ProductModalComponent } from './shared/header/modals/product-modal/product-modal.component';
import { AddressModalComponent } from './shared/header/modals/address-modal/address-modal.component';
import { PasswordModalComponent } from './shared/header/modals/password-modal/password-modal.component';
...
@NgModule({
  ...
  entryComponents: [ComplainComponent, ProductModalComponent, AddressModalComponent, PasswordModalComponent],
